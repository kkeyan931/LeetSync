...
public:
    int thirdMax(vector<int>& nums) {
        ...
        for (int& num : nums) {
            ...
            // or curr num is bigger than firstMax, then curr num is the biggest
            // number.
            if (!firstMax.second || firstMax.first <= num) {
                thirdMax = secondMax;
                secondMax = firstMax;
            ...
            // or curr num is bigger than secondMax, then curr num is 2nd
            // biggest number.
            ...
            // or curr num is bigger than thirdMax, then curr num is 3rd biggest
            // number.
        ...
        // If third max was never updated, it means we don't have 3 distinct
        // numbers.
        if (!thirdMax.second) {
